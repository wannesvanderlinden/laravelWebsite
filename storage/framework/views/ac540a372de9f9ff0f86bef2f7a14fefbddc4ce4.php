<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="/">SpeelPlein Halle</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="/spellenForum"> Watch GameForum</a>
                    <a class="dropdown-item" href="/spellenForum/create">Create Game <span
                            class="sr-only"></span></a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="/profile">Watch profile <span class="sr-only"></span></a>
...
<?php /**PATH C:\xampp\htdocs\github\project-1---laravel-wannesvanderlinden\resources\views/partials\admin-header.blade.php ENDPATH**/ ?>